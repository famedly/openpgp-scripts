      ...
      perSystem =
        { pkgs, ... }:
        {
          ...
          packages = {
            ...
            fos-rotate-passwords = pkgs.writeShellScriptBin "fos-rotate-passwords" (
              builtins.readFile ./fos-rotate-passwords
            );
            fos-sync = pkgs.writeShellScriptBin "fos-sync" (builtins.readFile ./fos-sync);
            fos-working-directory = pkgs.writeShellScriptBin "fos-working-directory" (
              builtins.readFile ./fos-working-directory
            );
